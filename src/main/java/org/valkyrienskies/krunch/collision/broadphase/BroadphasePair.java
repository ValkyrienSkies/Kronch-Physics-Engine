...
/**
 * BroadphasePair class contains a pair of AABB-overlapping objects. {@link Dispatcher} can search a {@link
 * CollisionAlgorithm} that performs exact/narrowphase collision detection on the actual collision shapes.
 *
 * @author jezek2
 */
public class BroadphasePair {
    ...
    public static final Comparator<BroadphasePair> broadphasePairSortPredicate = new Comparator<BroadphasePair>() {
        public int compare(final BroadphasePair a, final BroadphasePair b) {
            // JAVA TODO:
            final boolean result = a.pProxy0.getUid() > b.pProxy0.getUid() ||
