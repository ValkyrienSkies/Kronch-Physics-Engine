...
/**
 * BroadphaseProxy is the main class that can be used with the Bullet broadphases. It stores collision shape type
 * information, collision filter information and a client object, typically a {@link CollisionObject} or {@link
 * RigidBody}.
 *
 * @author jezek2
 */
public class BroadphaseProxy {
    ...
    public BroadphaseProxy(final Object userPtr, final short collisionFilterGroup, final short collisionFilterMask) {
        this(userPtr, collisionFilterGroup, collisionFilterMask, null);
    }

    public BroadphaseProxy(final Object userPtr, final short collisionFilterGroup, final short collisionFilterMask,
        final Object multiSapParentProxy) {
