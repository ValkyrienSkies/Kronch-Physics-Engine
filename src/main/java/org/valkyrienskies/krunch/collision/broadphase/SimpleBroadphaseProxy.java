...
class SimpleBroadphaseProxy extends BroadphaseProxy {
    ...
    public SimpleBroadphaseProxy(
        final Vector3f minpt, final Vector3f maxpt, final BroadphaseNativeType shapeType, final Object userPtr,
        final short collisionFilterGroup, final short collisionFilterMask, final Object multiSapProxy) {
